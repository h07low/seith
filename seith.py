...
def parse_args():
    ...
    exec.add_argument('container', help='container where to run the command')
    exec.add_argument('command', nargs='*', help='command to execute')
